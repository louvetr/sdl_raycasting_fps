    ...
    for(int i = 0; i < MAP_HEIGHT; i++) {
        for(int j = 0; j < MAP_WIDTH; j++) {
            ...
            switch (rawMap[i][j]) {
                // Floors
                case 0x00:
                    floors->blocks[idx]->setTextureFloor(gfxGetTexture(grass), TEXTURE_SIZE, TEXTURE_SIZE, 2);
                    break;
                case 0x01:
                    floors->blocks[idx]->setTextureFloor(gfxGetTexture(water), TEXTURE_SIZE, TEXTURE_SIZE, 2);
                    break;
                case 0x02:
                    floors->blocks[idx]->setTextureFloor(gfxGetTexture(gravel), TEXTURE_SIZE, TEXTURE_SIZE, 1);
                    break;
                case 0x03:
                    floors->blocks[idx]->setTextureFloor(gfxGetTexture(wood), TEXTURE_SIZE, TEXTURE_SIZE, 1);
                    break;
                case 0x04:
                    floors->blocks[idx]->setTextureFloor(gfxGetTexture(mossycobble), TEXTURE_SIZE, TEXTURE_SIZE, 2);
                    break;
                ...
                case 0x10:
                    ...
                    break;
                case 0x20:
                    floors->blocks[idx]->setTextureWall(gfxGetTexture(brick), TEXTURE_SIZE, TEXTURE_SIZE, 1);
                    break;
                case 0x30:
                    floors->blocks[idx]->setTextureWall(gfxGetTexture(stone_brick), TEXTURE_SIZE, TEXTURE_SIZE, 1);
                    break;
                case 0x40:
                    floors->blocks[idx]->setTextureWall(gfxGetTexture(wood), TEXTURE_SIZE, TEXTURE_SIZE, 1);
                    break;
                case 0x50:
                    floors->blocks[idx]->setTextureWall(gfxGetTexture(obsidian_block), TEXTURE_SIZE, TEXTURE_SIZE, 1);
                    break;
                case 0x60:
                    floors->blocks[idx]->setTextureWall(gfxGetTexture(stone), TEXTURE_SIZE, TEXTURE_SIZE, 1);
                    break;
                case 0x70:
                    floors->blocks[idx]->setTextureWall(gfxGetTexture(steel_block), TEXTURE_SIZE, TEXTURE_SIZE, 1);
                    break;
